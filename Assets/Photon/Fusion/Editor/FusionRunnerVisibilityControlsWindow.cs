namespace Fusion.Editor {
  ...
  public class FusionRunnerVisibilityControlsWindow : EditorWindow {
    ...
    private void CreateOrDestroyFusionStats(NetworkRunner runner) {
      // Fusion Statistics overlay feature removed from this project (unused, broken internal
      // dependency after the Fusion 2.1.1 import) - this debug toggle is a no-op now.
    }
